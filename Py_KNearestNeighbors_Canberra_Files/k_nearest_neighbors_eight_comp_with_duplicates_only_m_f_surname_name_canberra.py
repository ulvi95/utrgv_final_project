...
if __name__ == "__main__":
    ...
    csv_K_Nearest_Neighbours_Eight_results = folder_path_one_level_up + os.sep + "Results" + os.sep + "K_Nearest_Neighbours_Eight_results_surname_name_M_F_only_Canberra.csv"
