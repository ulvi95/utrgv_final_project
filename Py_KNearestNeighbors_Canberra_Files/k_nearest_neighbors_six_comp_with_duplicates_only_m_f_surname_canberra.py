...
if __name__ == "__main__":
    ...
    csv_K_Nearest_Neighbours_Six_results = folder_path_one_level_up + os.sep + "Results" + os.sep + "K_Nearest_Neighbours_Six_results_surnames_only_M_F_only_Canberra.csv"
