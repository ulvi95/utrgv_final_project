...
if __name__ == "__main__":
    ...
    csv_K_Nearest_Neighbours_Ten_results_no_duplicates = folder_path_one_level_up + os.sep + "Results" + os.sep + "K_Nearest_Neighbours_Ten_results_no_duplicates_names_only_Canberra.csv"
