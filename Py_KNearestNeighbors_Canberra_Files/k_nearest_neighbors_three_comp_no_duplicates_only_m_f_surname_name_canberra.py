...
if __name__ == "__main__":
    ...
    csv_K_Nearest_Neighbours_Three_results_no_duplicates = folder_path_one_level_up + os.sep + "Results" + os.sep + "K_Nearest_Neighbours_Three_results_no_duplicates_surname_name_M_F_only_Canberra.csv"
