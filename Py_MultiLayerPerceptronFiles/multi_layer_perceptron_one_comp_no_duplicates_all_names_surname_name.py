...
if __name__ == "__main__":
    ...
    csv_Multi_Layer_Perceptron_OneLayer_results_no_duplicates = folder_path_one_level_up + os.sep + "Results" + os.sep + "Multi_Layer_Perceptron_OneLayer_results_no_duplicates_surname_name.csv"
