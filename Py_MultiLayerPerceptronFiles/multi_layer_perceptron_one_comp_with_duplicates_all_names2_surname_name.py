...
if __name__ == "__main__":
    ...
    csv_Multi_Layer_Perceptron_OneLayer_results = folder_path_one_level_up + os.sep + "Results" + os.sep + "Multi_Layer_Perceptron_OneLayer_results_surname_name_2.csv"
    ...
    (pd.DataFrame(total_accuracy_scores)).to_csv(csv_Multi_Layer_Perceptron_OneLayer_results, header=False, index=False)
