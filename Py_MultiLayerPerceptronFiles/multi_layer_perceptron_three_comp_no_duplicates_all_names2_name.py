...
if __name__ == "__main__":
    ...
    for test_percent in range(99, 0, -1):
        ...
        classifier_Multi_Layer_Perceptron.add(Dense(len(x_train)//6, input_dim=1, activation='sigmoid'))
        classifier_Multi_Layer_Perceptron.add(Dense(len(x_train)//6, activation='sigmoid'))
        classifier_Multi_Layer_Perceptron.add(Dense(len(x_train)//6, activation='sigmoid'))
