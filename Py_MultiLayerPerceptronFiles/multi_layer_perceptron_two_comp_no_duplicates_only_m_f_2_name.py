...
if __name__ == "__main__":
    ...
    csv_Multi_Layer_Perceptron_TwoLayer_results_no_duplicates = folder_path_one_level_up + os.sep + "Results" + os.sep + "Multi_Layer_Perceptron_TwoLayer_results_no_duplicates_names_only_M_F_only_2.csv"
