...
if __name__ == "__main__":
    ...
    csv_Random_Forest_results_no_duplicates_entropy = folder_path_one_level_up + os.sep + "Results" + os.sep + "Random_Forest_Ten_results_no_duplicates_entropy_surname_name_M_F_only_2.csv"
