...
if __name__ == "__main__":
    ...
    csv_SVM_Linear_results_no_duplicates = folder_path_one_level_up + os.sep + "Results" + os.sep + "SVM_Linear_results_no_duplicates_names_only.csv"
    ...
    for test_percent in range(99, 0, -1):
        ...
        classifier_svm_linear = LinearSVC()
