...
if __name__ == "__main__":
    ...
    csv_SVM_Linear_results = folder_path_one_level_up + os.sep + "Results" + os.sep + "SVM_Linear_results_names_only_2.csv"
    ...
    accuracy_score_min = "Minimum SVM Linear for " + str(get_variable_name(names_only, locals())[0]) + " in " + str(csv_with_all_surnames.split(os.sep)[-1]) + " is: " + str(min(accuracy_score)) + " with training data fraction " + str(accuracy_score.index(min(accuracy_score))+1) + "%"
    ...
    file_results_log2.close()
    accuracy_score_average = "Average SVM Linear accuracy for " + str(get_variable_name(names_only, locals())[0]) + " in " + str(csv_with_all_surnames.split(os.sep)[-1]) + " is: " + str(round((sum(accuracy_score) / len(accuracy_score)),2))
