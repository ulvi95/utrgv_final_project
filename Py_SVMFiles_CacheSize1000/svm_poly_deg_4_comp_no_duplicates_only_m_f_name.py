...
if __name__ == "__main__":
    ...
    csv_SVM_Poly_Degree_Four_results_no_duplicates = folder_path_one_level_up + os.sep + "Results" + os.sep + "SVM_Poly_Degree_Four_results_no_duplicates_names_only_M_F_only.csv"
